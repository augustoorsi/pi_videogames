//Modulo donde definimos (sequelize) y la conectamos con la base de datos 
...
// module.exports = {
//   ...sequelize.models, // para poder importar los modelos así: const { Product, Videogame } = require('./db.js');
